  ...
  window.VSTORE_PRODUCTS = [
    {
      ...
      featuredImage: "assets/catalog/fortnite-vstore.png",
      featuredMobileImage: "assets/catalog/fortnite-vstore.png",
    ...
    },
    {
      ...
      featuredImage: "assets/catalog/discord-vstore.png",
      featuredMobileImage: "assets/catalog/discord-vstore.png",
    ...
    },
    {
      ...
      featuredImage: "assets/catalog/playstation-vstore-224x165.png",
      featuredMobileImage: "assets/catalog/playstation-vstore-224x165.png",
    ...
    },
    {
      ...
      priceFrom: "от 312 ₽",
      description: "Пополнение баланса Steam RU по логину. Сумма считается по курсу сайта 1.04 с комиссией 4%.",
      accent: "#8b5cf6",
      accentRgb: "139, 92, 246",
      watermark: "STEAM",
      benefits: [
        { icon: "✓", label: "RU регион" },
        { icon: "↯", label: "Комиссия 4%" },
        { icon: "◇", label: "По логину Steam" },
        { icon: "◎", label: "Минимум 300 ₽" }
      ],
      details: [
        "Пополнение баланса Steam для аккаунтов региона RU.",
        "Комиссия сайта составляет 4%: сумма пополнения умножается на курс 1.04.",
