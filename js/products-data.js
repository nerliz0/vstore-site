  ...
  window.VSTORE_PRODUCTS = [
    {
      ...
      featuredImage: "assets/catalog/fort.jpeg",
      featuredMobileImage: "assets/catalog/fort.jpeg",
    ...
    },
    {
      ...
      category: "Игры",
      filters: ["games", "topup"],
      image: "assets/catalog/pubgb.jpeg",
    ...
    },
    {
      ...
      category: "Игры",
      filters: ["games", "topup"],
      image: "assets/catalog/main.jpeg",
    ...
    },
    {
      ...
      category: "Подписки",
      filters: ["subs"],
      image: "assets/catalog/ds.jpeg",
      featuredImage: "assets/catalog/ds.jpeg",
      featuredMobileImage: "assets/catalog/ds.jpeg",
    ...
    },
    {
      ...
      category: "Игры",
      filters: ["games", "topup"],
      image: "assets/catalog/riot.jpeg",
    ...
    },
    {
      ...
      category: "Игры",
      filters: ["games", "topup"],
      image: "assets/catalog/battla.jpeg",
    ...
    },
    {
      ...
      category: "Игры",
      filters: ["games", "topup"],
      image: "assets/catalog/valorant.jpeg",
    ...
    },
    {
      ...
      category: "Подписки",
      filters: ["subs"],
      image: "assets/catalog/xbox.jpeg",
    ...
    },
    {
      ...
      category: "Карты",
      filters: ["cards", "topup"],
      image: "assets/catalog/appel.jpeg",
    ...
    },
    {
      ...
      category: "Карты",
      filters: ["cards", "topup"],
      image: "assets/catalog/psn.jpeg",
      featuredImage: "assets/catalog/psn.jpeg",
      featuredMobileImage: "assets/catalog/psn.jpeg",
    ...
    },
    {
      ...
      aliases: ["Стим", "Steam Wallet", "Стим кошелек", "пополнение стима", "баланс стим", "баланс Steam", "RU", "Россия"],
      items: ["Пополнение", "RU", "Баланс"],
      priceFrom: "от 324 ₽",
      description: "Пополнение баланса Steam RU по логину. Комиссия зависит от суммы: 8%, 6% или 4%.",
      accent: "#8b5cf6",
      accentRgb: "139, 92, 246",
      watermark: "STEAM",
      benefits: [
        { icon: "✓", label: "RU регион" },
        { icon: "↯", label: "Комиссия от 4%" },
        { icon: "◇", label: "По логину Steam" },
        { icon: "◎", label: "Минимум 300 ₽" }
      ],
      details: [
        "Пополнение баланса Steam для аккаунтов региона RU.",
        "Комиссия сайта считается по сумме пополнения: 300-1000 ₽ — 8%, 1001-2000 ₽ — 6%, от 2001 ₽ — 4%.",
        "Чтобы купить, укажите логин Steam и сумму пополнения -> добавьте заказ в корзину -> отправьте готовое сообщение в Telegram."
      ],
      guarantee: "Проверка перед выдачей",
      prices: [
        {
          title: "Быстрые суммы RU",
          rows: [
            ["500 ₽ на баланс", "540 ₽"],
            ["1000 ₽ на баланс", "1080 ₽"],
            ["1500 ₽ на баланс", "1590 ₽"],
